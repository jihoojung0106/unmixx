...
class MyDataset(Dataset):
    def __init__(self, isfinetune=False,simple=False,sample_rate=24000,
        ...
        if not self.isfinetune: #Best pop , diff, HARMONY, SAME SINGER, SAME SONG, lead_align
            #self.rand_order=[0.1,0.6,0.7,0.85,0.95]
            self.rand_order=[0.0,0.2,0.7,0.8,0.1]
        else:
    ...
    def getitem(self, idx):
        ...
        try:
            ...
            if save_:
                ...
                folder=f"result/jpoop_idol/wav/{category}_{generate_random_string(3)}"
...
class DuetDataModuleTimeSimple(LightningDataModule):
    def __init__(
        self,
        train_dir: str,
        valid_dir: str,
