...
class DuetSingingSpeechMixTraining(Dataset):
    ...
    def getitem(self, idx):
        ...
        visualize=True
        if visualize:
            save_folder=f"result/harmonic_score_{generate_random_string(3)}"
            os.makedirs(save_folder, exist_ok=True)
            save_audio(mixture, f"{save_folder}/mixture.wav", self.sample_rate)
...
class SingingLibriDataModuleHarmony(LightningDataModule):
    def __init__(
        self,
        train_dir: str,
        valid_dir: str,
