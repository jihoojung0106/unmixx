...
class DuetSingingSpeechMixTraining(Dataset):
    ...
    def __init__(
        ...
        song_length_dict_path: str= "duet_svs/24k/json/song_length_dict_24k.json",
        ...
        *,
        ...
        unison_prob: float = 0.1,             # ← argparse --unison_prob
        pitch_formant_augment_prob: float = 0.2,
        augment: bool = True,
        part_of_data: float= None,
        reduced_training_data_ratio: float = 1.0,
        sing_sing_ratio: float = 0.5,
        sing_speech_ratio: float = 0.0,
        same_song_ratio: float = 0.25,
        same_singer_ratio: float = 0.25,
        ...
        if song_length_dict_path is None:
            song_length_dict_path = "duet_svs/24k/json/song_length_dict_24k.json"
...
class OptimDataModule(LightningDataModule):
    def __init__(
        self,
        train_dir: str,
        valid_dir: str,
