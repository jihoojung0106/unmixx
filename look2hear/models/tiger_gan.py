...
class TIGERGAN1(BaseModel):
    def __init__(
        ...
        super(TIGERGAN1, self).__init__(sample_rate=sample_rate)
        ...
        self.refiner = Recurrent(self.feature_dim, in_channels, self.nband, upsampling_depth, att_n_head, att_hid_chan, att_kernel_size, att_stride, 2)       
    ...
    def do_istft(self, spec, nsample):
        ...
        return output
    def refine(self,input,sep_output,subband_spec):
        ...
        sep_subband_spec = []
        sep_output = self.refiner(sep_output.view(batch_size*nch, self.nband, self.feature_dim, -1))  # B, nband, N, T
        for i in range(self.nband):
    ...
    def forward(self, input,inter=False,istest=False):
        ...
        return reconstructed,sep_output,subband_spec
