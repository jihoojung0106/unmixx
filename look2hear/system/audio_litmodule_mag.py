...
class AudioLightningModuleMag1(pl.LightningModule):
    def __init__(
        self,
        audio_model=None,
        video_model=None,
        ...
        isfirst=True
        if isfirst:
            resume = torch.load("Experiments/checkpoint/fin_van1/20250716_23 copy/epoch=100.ckpt")#"Experiments/checkpoint/fin_van1/20250716_23/epoch=266.ckpt")
            epoch_= resume["epoch"]
