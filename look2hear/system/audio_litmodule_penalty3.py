...
from look2hear.losses.stft_loss import STFTLoss,STFTLossPenalty
...
class AudioLightningModulePenalty3(pl.LightningModule):
    def __init__(
        self,
        audio_model=None,
        video_model=None,
        ...
        super().__init__()
        self.stft_loss=STFTLossPenalty()
        ...
        isfirst=True
        if isfirst:
            resume = torch.load("Experiments/checkpoint/fin_van1/20250716_23 copy/epoch=204.ckpt")
            epoch_= resume["epoch"]
    ...
    def training_step(self, batch, batch_nb):
        ...
        return {"loss": loss + mag_loss*0.1 + penalty_loss*0.01}
