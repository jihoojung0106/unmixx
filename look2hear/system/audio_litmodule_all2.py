...
class AudioLightningModuleAll2(pl.LightningModule):
    def __init__(
        self,
        audio_model=None,
        video_model=None,
        ...
        if isfirst:
            resume = torch.load("Experiments/checkpoint/fin_all_rev/20250824_07/epoch=60.ckpt")
            epoch_= resume["epoch"]
            self.my_epoch_start= epoch_ + 210 # Set the current epoch to the loaded epoch
