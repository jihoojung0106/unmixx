...
class AudioLightningModulePenalty5(pl.LightningModule):
    def __init__(
        self,
        audio_model=None,
        video_model=None,
        ...
        self.win=960
        self.stride=240
        isfirst=True #Experiments/checkpoint/penalty0/20250808_09/epoch=23.ckpt
        if isfirst:
            resume = torch.load("Experiments/checkpoint/penalty0/20250805_02/epoch=178.ckpt")
            epoch_= resume["epoch"]
    ...
    def training_step(self, batch, batch_nb):
        ...
        return {"loss": loss + mag_loss*0.1+penalty_loss*0.002}
