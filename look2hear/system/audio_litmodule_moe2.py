...
class AudioLightningModuleMoe2(pl.LightningModule):
    def __init__(
        self,
        audio_model=None,
        video_model=None,
    ...
    def training_step(self, batch, batch_nb):
        mixtures, targets, category = batch #est_sources,est_sources_final,_,_,spec,spec_final,_ 
        ...
        chunked_est_sources1 = chunk_spec(spec[:,0])
        chunked_est_sources2 = chunk_spec(spec[:,1])
