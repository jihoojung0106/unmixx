...
class AudioLightningModuleSir1(pl.LightningModule):
    def __init__(
        self,
        audio_model=None,
        video_model=None,
    ...
    def training_step(self, batch, batch_nb):
        ...
        sir_loss_= sir_loss(est_sources_final, target_wav_reordered)
        self.log(
            "train_sir_loss",
            sir_loss_,
            on_epoch=True,
        ...
        return {"loss": loss+loss_refined+ sir_loss_*0.05}
    ...
    def validation_step(self, batch, batch_nb, dataloader_idx):
        ...
        if (self.trainer.current_epoch) % 1 == 0 and dataloader_idx >= 1:
            ...
            sir_loss_= sir_loss(est_sources_final, target_wav_reordered)
            self.log(
                f"test_sir_loss_{dataloader_idx}",
                sir_loss_,
                on_epoch=True,
                prog_bar=True,
                sync_dist=True,
