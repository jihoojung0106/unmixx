...
from look2hear.losses.stft_loss import STFTLoss
...
class AudioLightningModuleUnison4(pl.LightningModule):
    def __init__(
        self,
        audio_model=None,
        video_model=None,
    ...
    def training_step(self, batch, batch_nb):
        ...
        mag_loss1,pha_loss1=self.stft_loss(mag_target_reordered[:,0],mag_est1,pha_target_reordered[:,0],pha_est1) #clean_mag, mag_g, clean_pha, pha_g
        mag_loss2,pha_loss2=self.stft_loss(mag_target_reordered[:,1],mag_est2,pha_target_reordered[:,1],pha_est2) #clean_mag, mag_g, clean_pha, pha_g
        loss_mag = (mag_loss1 + mag_loss2) / 2
        loss_pha = (pha_loss1 + pha_loss2) / 2
        ...
        return {"loss": loss + loss_mag*0.1 + loss_pha*0.02}
