...
class MyJpopDataset(Dataset):
    def __init__(self, isfinetune=False,simple=True,sample_rate=24000,
...
def main(args):
   ...
   # args.seq_dur=4
    ...
    all_metrics_df.to_csv(f"{eval_save_dir}/all_metrics_jpop.csv")
    ...
    with open(f"{eval_save_dir}/final_metrics_jpop.json", "w") as f:
