...
def main(args):
    ...
    if args.use_overlapadd:
        ...
        eval_save_dir = (
            f"{exp_dir}/result_norm_{os.path.basename(model_path).split('.')[0]}"
        )
    ...
    try:
        ...
        print("epcoh,",torch.load(model_path, map_location='cpu')["epoch"])
...
if __name__ == "__main__":
    ...
    # Added arguments
    parser.add_argument("--pretrained",default="Experiments/checkpoint/fin_all_rev5/20250827_01/epoch=236.ckpt",type=str)
    parser.add_argument(
        "--test_target",
        type=str,
        default="singing",
