...
class Wav2Vec2FeatureExtractor(nn.Module):
    def __init__(
        ...
        # reload model
        state= fairseq.checkpoint_utils.load_checkpoint_to_cpu(ckpt_path)
        ...
        keys_to_remove = [
            ...
            'eval_wer_config',
            'eval_wer_tokenizer',
            'eval_wer_post_process','autoregressive'
        ]
        ...
        wav2vec_model = task.build_model(cfg.model, from_checkpoint=True)
