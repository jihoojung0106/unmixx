...
for json_path in json_files:
    json_path="duet_svs/nus/nus-smc-corpus_48/KENN/sing/04_unison.json"
    #json_path="en001a_longest_and_segments.json"
    ...
    try:
        ...
        out_mix_folder="result/unison_my/nus/"+generate_random_string(4)
