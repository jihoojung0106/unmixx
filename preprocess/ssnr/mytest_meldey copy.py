...
def main(args):
    ...
    model_path="Experiments/checkpoint/penalty5/20250812_04/best_model.pth" #Experiments/checkpoint/ver1/20240621_07/config.yaml
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        default="duet_svs/duet_svs/MedleyVox_cross",
